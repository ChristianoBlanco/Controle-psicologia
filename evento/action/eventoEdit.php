<?php
	...
	if (isset($_POST['delete']) && isset($_POST['id_evento'])){
	...
	}else if (isset($_POST['titulo']) && isset($_POST['descricao']) && isset($_POST['inicio']) && isset($_POST['termino']) && isset($_POST['rec']) && isset($_POST['cor']) && isset($_POST['id_evento'])){
		...
		$sql = "UPDATE eventos SET  titulo = '$titulo', descricao = '$descricao', inicio = '$inicio', termino = '$termino', recorrencia = '$recorrencia', cor = '$cor' WHERE id_evento = $id_evento ";
