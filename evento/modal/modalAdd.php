				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  ...
					  <option value="">Escolher</option>
						  ...
						  <option  value="TODOS_DIA">Todos os Dias</option>
						  <option  value="CADA_SEM">A Cada Semanas</option>						  
						  <option  value="CADA_2_SEM">A Cada 2 Semanas</option>
						  <option  value="CADA_MES"><?= utf8_encode("A Cada M�s"); ?> </option>
						  <option  value="CADA_ANO">A Cada Ano</option>						  
						</select>
					</div>
				  </div>
